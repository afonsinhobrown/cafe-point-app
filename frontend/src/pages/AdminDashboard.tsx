...
const AdminDashboard: React.FC = () => {
    ...
    const [newPlan, setNewPlan] = useState({ name: '', monthlyPrice: '', maxUsers: '', maxTables: '', maxItems: '' });
    ...
    const handleCreatePlan = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setNewPlan({ name: '', monthlyPrice: '', maxUsers: '', maxTables: '', maxItems: '' });
            loadData();
        } catch (error) {
                ...
                <tbody>
                    {restaurants.map(r => (
                        <tr key={r.id}>
                            ...
                            <td><span className="badge-plan">{r.license?.plan?.name || 'TRIAL'}</span></td>
                        ...
                        <div className="payment-modal" style={{ maxWidth: '600px', width: '90%' }}>
                            ...
                            <div className="admin-section" style={{ boxShadow: 'none', margin: 0, padding: '20px', maxHeight: '70vh', overflowY: 'auto' }}>
                                <table className="admin-table">
                                    ...
                                    <tbody>
                                        {currentHistory.length === 0 && <tr><td colSpan={5}>Nenhum histórico disponível.</td></tr>}
